...
const ContactCard: React.FC<ContactCardProps> = ({
    ...
    return (
        <div className={`w-[400px] h-[135px] flex-shrink-0 ${className || ""}`}>
            {/* Card Background */}
            <div className="w-[400px] h-[135px] flex-shrink-0 rounded-[20px] bg-[#171717] relative">
                {/* Profile Image with Yellow Background */}
                <div className="w-[119px] h-[119px] flex-shrink-0 absolute left-[10px] top-[8px]">
                    <div className="w-[119px] h-[119px] flex-shrink-0 rounded-[20px] bg-[#FFD71A] absolute left-0 top-0 overflow-hidden">
                        <img
                            loading="lazy"
                            src={image}
                            alt={imageAlt}
                ...
                {/* Contact Information */}
                <div className="w-[209px] h-[69px] flex-shrink-0 absolute left-[162px] top-[34px]">
                    {/* Name and Role */}
                    <div
                        className="absolute left-0 top-0 leading-[100%] tracking-[-0.6px]"
                        style={{
                            color: "#FFF",
                            fontFamily:
                    ...
                    {/* Telegram Contact */}
                    <a
                        className="absolute left-0 top-[34px] flex items-center cursor-pointer hover:opacity-30 transition-opacity duration-300"
                    ...
                    >
                        ...
                        <div
                            className="leading-[100%] tracking-[-0.48px]"
                            style={{
                                color: "#FFF",
                                fontFamily:
                                    "Mabry Pro, -apple-system, Roboto, Helvetica, sans-serif",
                    ...
                    {/* Email Contact */}
                    <a
                        className="absolute left-0 top-[55px] flex items-center cursor-pointer hover:opacity-30 transition-opacity duration-300"
                        href={`mailto:${email}`}
                        target="_blank"
                    >
                        <svg
